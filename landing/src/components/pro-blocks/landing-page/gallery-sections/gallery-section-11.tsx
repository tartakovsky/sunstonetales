...
export function GallerySection11() {
        ...
        <div className="grid grid-cols-1 gap-10 lg:grid-cols-2 lg:gap-16">
          <div className="section-title-gap-lg mx-auto flex flex-col items-center text-center lg:items-start lg:text-left">
            ...
            <p className="text-muted-foreground text-lg/8 text-pretty">
              This section is a great way to showcase your product with a
              gallery of images. Showcase your product in a more engaging way.
            </p>
          </div>
          <Carousel
            setApi={setApi}
