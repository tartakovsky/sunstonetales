    ...
    <section className="bg-background section-padding-y">
      <div className="container-padding-x mx-auto flex max-w-7xl flex-col gap-10 md:gap-12">
        ...
        <div className="grid grid-cols-1 gap-3 lg:grid-cols-2">
          <Card className="flex flex-col gap-0 overflow-hidden rounded-xl p-0 shadow-xs lg:col-span-2 lg:flex-row">
            <CardContent className="space-y-2 p-6 lg:w-1/2">
            ...
            <div className="lg:w-1/2">
              <Image
                ...
                height={1000}
                width={1000}
                className="h-full max-h-[280px] w-full object-cover lg:max-h-[400px]"
              />
            </div>
          </Card>
          <Card className="gap-0 overflow-hidden rounded-xl p-0 shadow-xs">
