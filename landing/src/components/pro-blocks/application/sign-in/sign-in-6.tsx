...
export function SignIn6() {
  return (
    <div className="md:bg-muted items-center justify-center md:flex md:min-h-screen">
      <Card className="m-auto w-full rounded-none border-none shadow-none md:w-[400px] md:max-w-sm md:rounded-lg md:border md:shadow-md">
        {/* Header section */}
        <CardHeader className="space-y-2">
          <Logo className="mb-4" />
          <CardTitle className="text-xl md:text-3xl">Get started</CardTitle>
          <CardDescription>
