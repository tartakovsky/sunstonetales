...
export function SignUp3() {
  return (
    <div className="bg-background gap-x-6 py-12 md:flex md:min-h-screen md:p-6">
      {/* Left side: Sign-up form */}
      <div className="flex items-center justify-center md:w-1/2">
        <div className="w-full max-w-sm px-6 md:p-0">
          {/* Logo and header */}
      ...
      <div className="bg-destructive relative hidden min-h-full w-1/2 flex-col-reverse overflow-hidden rounded-xl bg-[url('https://ui.shadcn.com/placeholder.svg')] bg-cover bg-center md:flex">
