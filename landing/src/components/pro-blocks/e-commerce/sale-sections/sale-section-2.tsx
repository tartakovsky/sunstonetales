...
export default function SaleSection2({
  ...
  return (
    <section className="relative overflow-hidden bg-[url('https://ui.shadcn.com/placeholder.svg')] bg-cover bg-center pt-32 pb-6">
        ...
        <div className="bg-background relative max-w-xl rounded-lg p-6">
          ...
          <div className="mb-8 flex items-start gap-1">
            ...
            <div className="flex flex-col items-center gap-1">
              <div className="bg-muted text-foreground flex min-h-[48px] min-w-[48px] items-center justify-center text-xl font-semibold md:min-h-[60px] md:min-w-[60px] md:text-3xl">
