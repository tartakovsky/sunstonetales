...
import ProductImageCarousel3 from "@/components/pro-blocks/e-commerce/product-image-carousel-3";
...
import ColorVariantField from "@/components/pro-blocks/e-commerce/color-variant-field";
...
export default function ProductHeader5({
            ...
            <div className="flex flex-col gap-8">
              ...
              <div className="flex flex-col gap-5">
                ...
                >
                  ...
                  <span className="text-muted-foreground text-sm font-medium hover:underline">
