...
import ProductCard3, {
  Product,
} from "@/components/pro-blocks/e-commerce/product-card-3";
...
export default function ProductListSection6({
  ...
  return (
    <section className="bg-background section-padding-y">
      <div className="container-padding-x mx-auto flex w-full max-w-7xl flex-col gap-8 md:gap-12">
        <h1 className="text-foreground heading-lg w-full text-center">
          {title}
        </h1>
